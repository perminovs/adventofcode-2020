...
testDataRaw = "light red bags contain 1 bright white bag, 2 muted yellow bags.\n\
...
myDataRaw = "muted tomato bags contain 1 bright brown bag, 1 dotted gold bag, 2 faded gray bags, 1 posh yellow bag.\n\
